levelChecker = (function() {
    ...
    setupLevel = function(){
        ...
        switch(currentLevel){
               case 1: levelManager.prepareTools(1,1,0,0,1); break;
               case 2: levelManager.prepareTools(4,2,2,1,1); break;
               case 3: levelManager.prepareTools(2,2,2,1,1); break;
               case 4: levelManager.prepareTools(2,2,2,0,0); break;
               case 5: levelManager.prepareTools(2,2,2,1,0); break;
               default:levelManager.prepareTools(2,2,2,0,1); break;
       }
    },
